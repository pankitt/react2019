        ...
        return (
            <section className="page-home">
                ...
                <ul>
                    ...
                    <li><Link to="/learn/012">012 Lists and Keys</Link></li>
                    <li><Link to="/learn/013">013 Forms</Link></li>
                    <li><Link to="/learn/014">014 Forms</Link></li>
                    ...
                    <li><Link to="/learn/025">025 Thinking In React</Link></li>
                </ul>
                {this.props.children}
            </section>
        )
